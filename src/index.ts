...
import { registerDetailsCommand } from "@/commands/details";
...
import { registerRebootCommand } from "@/commands/reboot";
...
program.addCommand(registerDetailsCommand());
program.addCommand(registerRebootCommand());
